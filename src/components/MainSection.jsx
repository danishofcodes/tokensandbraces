        ...
        <main className="main-section pt-5">
            <div className="left-part">
                ...
                <div className='navPoints mt-3' >
                    ...
                    <a href="https://drive.google.com/file/d/1HgTNTIi1jJf6Z7nIQOZYKQfbNIqrLPqf/view?usp=drive_link"> <button className="bg-transparent hover:bg-green-500 text-indigo-600 font-semibold hover:text-white py-2 px-4 border border-indigo-600 hover:border-transparent rounded flex ">
