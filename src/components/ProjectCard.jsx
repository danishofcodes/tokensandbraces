        ...
        <div className="card rise fadeUpanimate">
            ...
            <div className="card-details flex">
                ...
                <div className="flex items-center justify-evenly">
                    <a href={view} target="_blank" className=" bg-[#ff8b36] text-stone-100 px-3 py-1 rounded-full hover:bg-[#801dff] hover:text-white  me-1" ><FontAwesomeIcon icon={faChrome} /> View </a>
